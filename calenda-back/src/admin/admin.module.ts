...
@Module({
  imports: [CommonModule, EventsModule, EtablissementsModule, TypeOrmModule.forFeature([Event, EventSlot, User, UserProfileReport, ConversationGroup])],
  controllers: [AdminController],
  providers: [MartiguesMergeService, SalsaOlivierMergeService, CarryLeRouetMergeService, SaussetMergeService],
})
